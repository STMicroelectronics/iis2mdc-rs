...
```toml
[dependencies]
iis2mdc-rs = { version = "2.0.0", default-features = false, features = ["blocking"] }
```
or from the terminal:
```sh
cargo add iis2mdc-rs --no-default-features --features blocking
```
...
More details and instructions are available in [bsp/README.md](https://github.com/STMicroelectronics/iis2mdc-rs/blob/main/bsp/README.md).
